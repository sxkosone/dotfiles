...
-- === autopairs ===
require('sk-autopairs')

-- === galaxyline ===
require('sk-statusline')

-- === nvim-lsp ===
require('sk-lsp-config')
...
-- === nvim-treesitter
require('sk-treesitter')

-- === trouble ===
require('trouble').setup {}
vim.api.nvim_set_keymap('n', '<Leader>xx', '<cmd>Trouble document_diagnostics<CR>', {noremap = true})
